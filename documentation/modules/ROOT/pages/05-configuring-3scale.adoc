...
. Log into 3scale using the below URL. (Do not forget to replace the *cluster wildcard url*)
+
[.lines_7]
[.console-input]
...
. You can retrieve the login credentials using the Console UI. Select 3scale project and Navigate to Developer > Secrets and search for *system-seed*
+
image::seed-nav.png[]
